...
class Hotel < ActiveRecord::Base
  ...
  def self.show_hotels(destination, arrive, depart) 
    ...
    response = Typhoeus.get("http://api.ean.com/ean-services/rs/hotel/v3/list?geoSearch?minorRev=5&apiKey=" + ENV['EAN_key'] + "&cid=55505&locale=en_US&destinationString=#{destination_fixed}&numberOfResults=40&arrivalDate=#{fixed_arrive}&departureDate=#{fixed_depart}&sort=DEFAULT&_type=json")
