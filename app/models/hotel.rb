...
class Hotel < ActiveRecord::Base
  ...
  def self.show_hotels(destination, arrive, depart)
    ...
    response = Typhoeus.get("http://api.ean.com/ean-services/rs/hotel/v3/list?geoSearch?minorRev=5&apiKey=6bjgco74rs2j90o5mkhmsabuqe&sig=6bjgco74rs2j90o5mkhmsabuqe8fj76j23ppr001431025260622&cid=55505&locale=en_US&destinationString=#{destination_fixed}&numberOfResults=40&arrivalDate=#{fixed_arrive}&departureDate=#{fixed_depart}&sort=DEFAULT&_type=json")
